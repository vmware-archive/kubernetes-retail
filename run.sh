...
export VCAP_SERVICES='{"p-rabbitmq-3.2.4":[{"name":"retail-mq","label":"p-rabbitmq-3.2.4","tags":["rabbitmq","messaging","message-queue"],"plan":"standard","credentials":{"uri":"amqp://guest:guest@'"$RABBIT_SERVICE_HOST:$RABBIT_SERVICE_PORT"'"}}]}'
